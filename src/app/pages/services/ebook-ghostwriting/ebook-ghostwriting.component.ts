...
@Component({
  ...
  templateUrl: './ebook-ghostwriting.component.html',
  styleUrls: ['./ebook-ghostwriting.component.css']
})
export class EbookGhostwritingComponent {
  pname: string = 'ebook-ghostwriting';
