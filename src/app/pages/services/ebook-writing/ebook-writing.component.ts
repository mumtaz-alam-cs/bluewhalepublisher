...
@Component({
  selector: 'app-ebook-writing',
  templateUrl: './ebook-writing.component.html',
  styleUrls: ['./ebook-writing.component.css']
})
export class EbookWritingComponent {
  pname: string = 'ebook-writing';
  ...
  trackByEbookWriting = (index: number, item: any) => {
    return item.id;
  }
