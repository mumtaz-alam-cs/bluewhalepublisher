...
@Component({
  selector: 'app-book-illustration',
  templateUrl: './book-illustration.component.html',
  styleUrls: ['./book-illustration.component.css']
})
export class BookIllustrationComponent {
  pname: string = 'book-illustration';
